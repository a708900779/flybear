...
<div class="jq-layout rel" data-options="fit:true">
	...
	<div data-options="region:'center',border:false">
		<table id="grid" class="jq-datagrid" fit="true" data-options="{
			url: '${z:u('baoming/list')}',   
			method:'post',
			columns: [[
				{field:'id',checkbox:true},
				{field:'activityId',title:'',width:100},
				{field:'studentId',title:'',width:100},
				{field:'time',title:'',width:100}
			]]}">
		</table>
	</div>
...
<script type="text/javascript">
	...
	$("#edit,#delete").click(function(){
		...
		if(row == null){
			...
			if(eleId=="edit"){
				App.popup('${z:u("baoming/edit")}?id='+row.id, {
				title : "编辑",
				width : 610,
				height : 270
			});
			}else if(eleId=="delete"){
	            App.ajax('${z:u("baoming/delete")}?id='+row.id,{
	            type: "POST"
	            });
